...
## Developing French-English Translator Using Transformer From PyTorch and TorchText (first uploaded on December 2021)
**Description**  
...
## Creating Fish Classification Using ResNet-18 From PyTorch (First uploaded on October 2021)
**Introduction** 
...
**Conclusions**
With sentiment analysis, surprisingly borrowers with more subjective and negative reasons have better ability to pay their debts. Borrowers who have their own house also have better ability. There is no correlation of the amount of loan with borrower's annual income or DTI.
"Renewable energy" and "Educational" are two major reasons with the highest probability of borrowers not paying debts. Iowa is the state with lowest loan payback ability by ratio 30 %. High interest rates can trigger low loan payback ability.
